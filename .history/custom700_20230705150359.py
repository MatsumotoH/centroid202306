...
while True:
    ...
    if 600 < new_centroid1 < 1200:  
      if objectID not in previous_centroids1:
        previous_centroids1[objectID] = new_centroid1
      else:
        if objectID in previous_centroids1:
          difference = new_centroid1 - previous_centroids1[objectID]
          ...
          if objectID in objectID_count1:
            del  objectID_count1[objectID]
          if objectID in objectID_count1: 
              if state in objectID_count1[objectID]:
    ...
    if 200 < new_centroid2 < 1200:
      if objectID not in previous_centroids2:
        previous_centroids2[objectID] = new_centroid2
      else:
        if objectID in previous_centroids2:
          defference = new_centroid2 - previous_centroids2[objectID]
          if difference > 0:
            state = 'IN'
          else:
            state = 'OUT'
